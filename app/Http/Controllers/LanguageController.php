...
class LanguageController extends Controller
{
    public function changeLanquage($lang)
    {
        ...
        return response()->json(['Status'=>'Success','message'=>'Language change successfully.','redirect'=>'back()'],200);
    }
    ...
    public function manageLanguage($currantLang)
    {
        ...
        return response()->json(['Status'=>'Success','message'=>'','languages'=>$languages,'currantLang'=>$currantLang,'arrLabel'=>$arrLabel,'arrMessage'=>$arrMessage],200);
    }
    ...
    public function storeLanguageData(Request $request, $currantLang)
    {
        if (\Auth::user()->can('manage-langauge')) {
            ...
            return response()->json(['Status'=>'Success','message'=>'Language save successfully.','redirect'=>'back()'],200);
        } else {
